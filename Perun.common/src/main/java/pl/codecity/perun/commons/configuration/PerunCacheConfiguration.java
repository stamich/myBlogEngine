package pl.codecity.perun.commons.configuration;
...
@Configuration
@EnableCaching
public class PerunCacheConfiguration extends CachingConfigurerSupport {
	...
	private static Logger logger = LoggerFactory.getLogger(PerunCacheConfiguration.class);
